                ...
                <div className="rounded-md border border-[#3c4f3d]/10 bg-white p-4">
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="rounded-md bg-[#e9eeea]/50 p-4">
                      ...
                      <div className="mt-3">
                        ...
                        <div className="mt-1 h-2 w-full rounded-full bg-[#e9eeea]/80">
                          <div
                            ...
                            style={{
                              width: `${(() => {
                                // Try to use confidence field first, then classification_confidence
                                const confidence =
                                  comparisonVariant.evo2Result?.confidence ??
                                  comparisonVariant.evo2Result
                                    ?.classification_confidence;
                                return confidence != null && !isNaN(confidence)
                      ...
                      <div className="mt-3">
                        <div className="mb-2 text-xs text-[#3c4f3d]/70">
                          Population Frequency Data:
                        </div>
                        <div className="space-y-1 text-xs">
                          <div className="flex justify-between">
                            ...
                            <span className="font-mono text-[#3c4f3d]">
                              {comparisonVariant.evo2Result?.african_af != null
                                ? comparisonVariant.evo2Result.african_af.toFixed(
                                    6,
                                  )
                                : "N/A"}
                            </span>
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-mono text-[#3c4f3d]">
                              {comparisonVariant.evo2Result?.global_af != null
                                ? comparisonVariant.evo2Result.global_af.toFixed(
                                    6,
                                  )
                                : "N/A"}
                            </span>
                          </div>
                          {comparisonVariant.evo2Result?.source && (
                            <div className="flex justify-between">
                              <span className="text-[#3c4f3d]/70">Source:</span>
                      ...
                      <div className="mt-3">
                        ...
                        <div className="space-y-1">
                          <div className="w-fit rounded-md bg-[#e9eeea]/50 px-2 py-1 text-xs font-medium text-[#3c4f3d]">
                            ...
                            <div className="flex items-center gap-1 text-xs">
                              ...
                              <span className="font-mono text-[#3c4f3d]">
                                {comparisonVariant.evo2Result
                                  ...
                                  ? "+"
                                  : ""}
                                {comparisonVariant.evo2Result.population_adjustment.toFixed(
                                  6,
                                )}
                              </span>
                            </div>
