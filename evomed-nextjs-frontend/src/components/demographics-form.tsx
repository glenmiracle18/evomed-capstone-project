...
const AFRICAN_ANCESTRIES = [
  ...
  { value: "cameroon-bamileke", label: "Cameroon - Bamileke (West Region)" },
  { value: "cameroon-fulani", label: "Cameroon - Fulani/Fulbe (North)" },
  { value: "cameroon-beti", label: "Cameroon - Beti-Pahuin (Centre/South)" },
  { value: "cameroon-duala", label: "Cameroon - Duala (Littoral)" },
  { value: "cameroon-bassa", label: "Cameroon - Bassa (Littoral)" },
  { value: "cameroon-bamoun", label: "Cameroon - Bamoun (West)" },
  { value: "cameroon-other", label: "Cameroon - Other" },
